...
argument-hint: [smoke|release|global]
---
...
Return the exact command results and keep proof layers separate: smoke pass,
global-hook pass, graph freshness, and release-grade pass are not the same
claim.
