...
3. `.codex/skills/meta-theory/SKILL.md`
...
- Use `agent-teams-playbook` only after Thinking and before Execution when the plan has 2+ independent parallel worker lanes. Resolve it from the first available skill root (`~/.codex/skills/agent-teams-playbook/SKILL.md`, `.agents/skills/agent-teams-playbook/SKILL.md`, `.codex/skills/agent-teams-playbook/SKILL.md`).
