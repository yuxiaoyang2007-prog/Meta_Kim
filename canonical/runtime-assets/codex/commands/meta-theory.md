...
- For any non-trivial task, first apply `agent-teams-playbook` from the first available skill root (`~/.codex/skills/agent-teams-playbook/SKILL.md`, `.agents/skills/agent-teams-playbook/SKILL.md`, `.codex/skills/agent-teams-playbook/SKILL.md`) to choose the orchestration scenario and team blueprint.
