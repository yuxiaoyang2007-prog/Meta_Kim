...
function validPolicy(overrides = {}) {
  return {
    ...
    requiredPreflightChecks: ["realIntent", "successCriteria", "fetchEvidence", "capabilityDiscovery", "runtimeMatrix", "osMatrix", "owner", "weapon", "verificationOwner", "verificationPlan", "rollbackPath", "warningsClassified", "writebackDecisionReserved"],
