...
const OUTPUT_DIR = reportContext.resolveStatePath("research-execution");
const CACHE_DIR = reportContext.resolveStatePath("research-evidence-cache");
